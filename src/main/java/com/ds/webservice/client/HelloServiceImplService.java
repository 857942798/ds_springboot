 ...
 * 
 */
@WebServiceClient(name = "HelloServiceImplService", targetNamespace = "http://impl.webservice.ds.com/", wsdlLocation = "http://localhost:6868/01-ws-java-server/ws?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICEIMPLSERVICE_QNAME = new QName("http://impl.webservice.ds.com/", "HelloServiceImplService");
    ...
    public HelloServiceImpl getHelloServiceImplPort() {
        return super.getPort(new QName("http://impl.webservice.ds.com/", "HelloServiceImplPort"), HelloServiceImpl.class);
    }
    ...
    public HelloServiceImpl getHelloServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.webservice.ds.com/", "HelloServiceImplPort"), HelloServiceImpl.class, features);
    }
