...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
    private static final DateTimeFormatter DATE_TIME_FORMAT_YYYY_MM_DD_HH_MM_SS = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss");
    private static final DateTimeFormatter DATE_TIME_FORMAT_YYYY_MM_DD_HH_MM = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm");
    ...
    public static Date parseToDate(String source,String timeZone) throws DateException {
        LocalDateTime localDateTime = parseToLocalDateTime(source);
    ...
    public static LocalDateTime parseToLocalDateTime(String source) throws DateException {
        LocalDateTime time;
        if (source.length() == "yyyy-MM-dd HH:mm:ss".length()) {
            time = LocalDateTime.parse(source, DATE_TIME_FORMAT_YYYY_MM_DD_HH_MM_SS);
        }else if(source.length() == "yyyy-MM-dd HH:mm".length()){
            time = LocalDateTime.parse(source, DATE_TIME_FORMAT_YYYY_MM_DD_HH_MM);
        }else {
    ...
    public static String formatDateTime(LocalDateTime localDateTime) {
        return DATE_TIME_FORMAT_YYYY_MM_DD_HH_MM_SS.format(localDateTime);
    }

    public static String formatDateTimeMinute(LocalDateTime localDateTime) {
        return DATE_TIME_FORMAT_YYYY_MM_DD_HH_MM.format(localDateTime);
    }
